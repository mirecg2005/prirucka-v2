...
const dict = {
  sk: {
    ...
    doc_1: "Vodičský preukaz", doc_2: "Osvedčenie (OEV časť I., malý TP)", doc_3: "Potvrdenie o PZP", doc_4: "Doklad o STK a EK, ak je vozidlo staršie ako 4 roky.", doc_5: "Občiansky preukaz",
  ...
  en: {
    ...
    doc_1: "Driver's license", doc_2: "Vehicle registration (Part 1)", doc_3: "Proof of insurance (PZP)", doc_4: "MOT/Emission test, if the vehicle is older than 4 years.", doc_5: "ID card",
